 ...
 *   EXEC SQL BEGIN DECLARE SECTION;
 */
#line 3410 "_informixdb.ec"
#line 3411 "_informixdb.ec"
int exc_count;
  char message[255];
int messlen;
  char sqlstate[6];
